...
<!-- All related Model -->
		...
		<div class="bottomContainer"
			...
			<% 
				String noMovie[];
				noMovie = new String[4];
				noMovie[0] = "/images/black-adam-poster.jpg";
				noMovie[1] = "/images/Mechamato-poster.jpg";
				noMovie[2] = "/images/SAO-poster.jpeg";
				noMovie[3] = "/images/Wakanda-poster.jpg";
