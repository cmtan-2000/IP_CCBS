...
<body>
	<div class="company__header">
		...
		<button type="button" class="btn btn-primary generateSales__btn">
	...
	<div class="hidden_contents" id="snacktab_desc">
		...
		<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
			Aliquid, quis quam voluptatibus natus soluta perspiciatis est magni
			aliquam, placeat quisquam recusandae velit. Facere, illum odit.
			Mollitia, qui minus! Itaque, iure.</p>
		<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
			Aliquid, quis quam voluptatibus natus soluta perspiciatis est magni
			aliquam, placeat quisquam recusandae velit. Facere, illum odit.
			Mollitia, qui minus! Itaque, iure.</p>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" method="">
						...
						<div class="row mb-3">
							<label for="hallType" class="col-sm-2 col-form-label w-50">Hall
								Type</label>
							<div class="col-sm-10">
						...
						<div class="row mb-3">
							<label for="airConditioner" class="col-sm-2 col-form-label w-50">Air
								Conditioner</label>
							<div class="col-sm-10">
						...
						<div class="row mb-3">
							<label for="soundSystem" class="col-sm-2 col-form-label w-50">Sound
								system</label>
							<div class="col-sm-10">
						...
						<div class="row mb-3">
							<label for="seatType" class="col-sm-2 col-form-label w-50">Seat
								type</label>
							<div class="col-sm-10">
						...
						<div class="row mb-3">
							<label for="hallPicture" class="col-sm-2 col-form-label w-50">Hall
								picture</label>
							<div class="col-sm-10">
